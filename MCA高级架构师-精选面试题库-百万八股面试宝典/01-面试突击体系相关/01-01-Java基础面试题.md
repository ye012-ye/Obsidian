...
> [!abstract] 速读地图
> 把 Java 基础拆成「对象、类型、集合、异常」四条线，先背对比题，再看代码细节。
>
> **本篇关键词：** <span style="color:#2563eb;font-weight:700">Java</span> ・ <span style="color:#2563eb;font-weight:700">OOP</span> ・ <span style="color:#059669;font-weight:700">集合</span> ・ <span style="color:#2563eb;font-weight:700">对象模型</span> ・ <span style="color:#dc2626;font-weight:700">异常处理</span> ・ <span style="color:#d97706;font-weight:700">equals/hashCode</span>
>
> **优先扫这些问题：**
> - 面向对象和集合专题
> - 面向对象和面向过程的区别
...
> [!warning] 易混提醒
> 易混：重载看参数列表，重写看继承关系；`equals` 相等通常要求 `hashCode` 也一致。
...
![](../assets/58b6c11c231084bc.png)

![](../assets/4ee21f5918831382.png)

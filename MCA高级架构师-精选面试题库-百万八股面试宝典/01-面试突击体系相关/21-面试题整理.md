...
> [!abstract] 速读地图
> 这篇是分布式组件合集：Dubbo 看 RPC，ZooKeeper 看一致性和选举，ES 看索引与分片。
>
> **本篇关键词：** <span style="color:#db2777;font-weight:700">Dubbo</span> ・ <span style="color:#db2777;font-weight:700">ZooKeeper</span> ・ <span style="color:#0891b2;font-weight:700">Elasticsearch</span> ・ <span style="color:#db2777;font-weight:700">CAP</span> ・ <span style="color:#dc2626;font-weight:700">脑裂</span> ・ <span style="color:#0891b2;font-weight:700">倒排索引</span> ・ <span style="color:#0891b2;font-weight:700">分片</span>
>
> **优先扫这些问题：**
> - Dubbo服务注册流程?
> - Dubbo配置优先级别
...
> [!warning] 易混提醒
> 易混：CAP 是取舍模型，不是三者全要；脑裂问题要结合多数派、选举和最小主节点数来讲。

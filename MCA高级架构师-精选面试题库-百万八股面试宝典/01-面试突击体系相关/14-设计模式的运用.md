...
> [!abstract] 速读地图
> 这篇适合准备项目表达：每个模式都按「意图 -> 场景 -> 代码落点 -> 对比」回答。
>
> **本篇关键词：** <span style="color:#d97706;font-weight:700">设计模式</span> ・ <span style="color:#d97706;font-weight:700">建造者</span> ・ <span style="color:#d97706;font-weight:700">责任链</span> ・ <span style="color:#d97706;font-weight:700">观察者</span> ・ <span style="color:#d97706;font-weight:700">适配器</span> ・ <span style="color:#d97706;font-weight:700">代理/装饰器</span>
>
> **优先扫这些问题：**
...
> [!warning] 易混提醒
> 易混：代理强调控制访问，装饰器强调增强能力；观察者和发布订阅的耦合程度不同。

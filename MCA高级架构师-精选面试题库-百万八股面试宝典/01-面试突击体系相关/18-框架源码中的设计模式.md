...
> [!abstract] 速读地图
> 这篇把设计模式落到框架源码，复习时重点记「哪个类用了什么模式，为什么」。
>
> **本篇关键词：** <span style="color:#d97706;font-weight:700">源码设计模式</span> ・ <span style="color:#16a34a;font-weight:700">Spring</span> ・ <span style="color:#7c3aed;font-weight:700">MyBatis</span> ・ <span style="color:#d97706;font-weight:700">工厂模式</span> ・ <span style="color:#d97706;font-weight:700">代理模式</span> ・ <span style="color:#d97706;font-weight:700">模板方法</span> ・ <span style="color:#d97706;font-weight:700">策略模式</span>
>
> **优先扫这些问题：**
> - Spring源码中的设计模式
> - MyBatis源码中的设计模式
...
> [!warning] 易混提醒
> 易混：面试不只问模式定义，更常问 Spring/MyBatis 里具体类的设计取舍。

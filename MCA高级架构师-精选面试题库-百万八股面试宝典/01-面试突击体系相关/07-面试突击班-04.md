...
> [!abstract] 速读地图
> 这篇补并发底层概念：从进程/线程/协程，到缓存可见性和伪共享。
>
> **本篇关键词：** <span style="color:#dc2626;font-weight:700">线程</span> ・ <span style="color:#dc2626;font-weight:700">协程</span> ・ <span style="color:#dc2626;font-weight:700">ThreadLocal</span> ・ <span style="color:#dc2626;font-weight:700">伪共享</span> ・ <span style="color:#d97706;font-weight:700">CPU缓存</span> ・ <span style="color:#dc2626;font-weight:700">可见性</span>
>
> **优先扫这些问题：**
> - 进程，线程，协程的区别
> - Java中创建线程方式
...
> [!warning] 易混提醒
> 易混：并发问题不只来自锁，还来自 CPU 缓存、内存可见性和数据布局。

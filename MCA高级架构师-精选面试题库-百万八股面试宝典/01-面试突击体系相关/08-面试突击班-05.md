...
> [!abstract] 速读地图
> 这篇是高频锁专题：按 volatile、CAS、synchronized、AQS 的层级往下讲。
>
> **本篇关键词：** <span style="color:#dc2626;font-weight:700">volatile</span> ・ <span style="color:#dc2626;font-weight:700">CAS</span> ・ <span style="color:#dc2626;font-weight:700">synchronized</span> ・ <span style="color:#dc2626;font-weight:700">锁升级</span> ・ <span style="color:#dc2626;font-weight:700">AQS</span> ・ <span style="color:#dc2626;font-weight:700">公平锁</span>
>
> **优先扫这些问题：**
...
> [!warning] 易混提醒
> 易混：`volatile` 解决可见性和有序性；CAS 乐观但可能有 ABA、自旋开销等问题。

...
> [!abstract] 速读地图
> 按「网络协议 -> HTTP -> Servlet/Tomcat -> 会话机制」来复习，适合补 Web 基础口述能力。
>
> **本篇关键词：** <span style="color:#0891b2;font-weight:700">JavaWeb</span> ・ <span style="color:#0891b2;font-weight:700">HTTP</span> ・ <span style="color:#0891b2;font-weight:700">TCP/UDP</span> ・ <span style="color:#0891b2;font-weight:700">Servlet</span> ・ <span style="color:#0891b2;font-weight:700">Tomcat</span> ・ <span style="color:#d97706;font-weight:700">Cookie/Session</span>
>
> **优先扫这些问题：**
> - JavaWeb专题
> - HTTP响应码有哪些
...
> [!warning] 易混提醒
> 易混：Forward 是服务端转发，Redirect 是客户端重定向；Cookie 在客户端，Session 主要在服务端。
...
![](../assets/26d931fbaf2255e4.png)

![](../assets/355712f164044e88.png)
...
![](../assets/2679a97d84d9df94.png)

三次握手：

1.第一次握手：客户端将标志位syn重置为1，随机产生seq=a，并将数据包发送给服务端  
2.第二次握手：服务端收到syn=1知道客户端请求连接，服务端将syn和ACK都重置为1，ack=a+1，随机产一个值seq=b，并将数据包发送给客户端，服务端进入syn\_RCVD状态。  

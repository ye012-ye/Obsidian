...
> [!abstract] 速读地图
> 这篇是并发容器和同步工具：重点看 ConcurrentHashMap 写安全、扩容和计数。
>
> **本篇关键词：** <span style="color:#059669;font-weight:700">ConcurrentHashMap</span> ・ <span style="color:#dc2626;font-weight:700">CAS</span> ・ <span style="color:#059669;font-weight:700">红黑树</span> ・ <span style="color:#059669;font-weight:700">扩容</span> ・ <span style="color:#dc2626;font-weight:700">CountDownLatch</span> ・ <span style="color:#dc2626;font-weight:700">Semaphore</span>
>
> **优先扫这些问题：**
> - ConcurrenHashMap存储结构？
> - ConcurrentHashMap保证写操作线程安全的方式？
> - ConcurrentHashMap的计数器实现？
> - ConcurrentHashMap的扩容大致流程？
> - ConcurrentHashMap获取数据？
> - CountDownLatch的运用。
> - Semaphore的运用。
...
> [!warning] 易混提醒
> 易混：ConcurrentHashMap 不是全表大锁；JDK8 主要靠 CAS + synchronized + 分段迁移思路。

...
> [!abstract] 速读地图
> 这篇偏性能优化：先看索引命中和执行计划，再看 SQL 改写与慢查询定位。
>
> **本篇关键词：** <span style="color:#059669;font-weight:700">MySQL优化</span> ・ <span style="color:#059669;font-weight:700">索引</span> ・ <span style="color:#059669;font-weight:700">执行计划</span> ・ <span style="color:#d97706;font-weight:700">慢查询</span> ・ <span style="color:#059669;font-weight:700">SQL改写</span> ・ <span style="color:#059669;font-weight:700">B+树</span>
>
> **优先扫这些问题：**
> - 如何进行慢SQL查询
> - 如何查看执行计划
...
> [!warning] 易混提醒
> 易混：有索引不等于一定走索引；优化要先定位瓶颈，再改 SQL、索引或表结构。

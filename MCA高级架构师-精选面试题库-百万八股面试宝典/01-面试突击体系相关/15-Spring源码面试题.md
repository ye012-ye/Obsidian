...
> [!abstract] 速读地图
> 这篇是 Spring 源码核心面：容器、Bean、AOP、事务、事件和循环依赖串成一条线。
>
> **本篇关键词：** <span style="color:#16a34a;font-weight:700">Spring</span> ・ <span style="color:#16a34a;font-weight:700">IoC</span> ・ <span style="color:#16a34a;font-weight:700">AOP</span> ・ <span style="color:#16a34a;font-weight:700">Bean生命周期</span> ・ <span style="color:#16a34a;font-weight:700">事务管理</span> ・ <span style="color:#dc2626;font-weight:700">循环依赖</span>
>
> **优先扫这些问题：**
> - 谈谈你对Spring框架的理解?
...
> [!warning] 易混提醒
> 易混：IoC 是对象创建和依赖交给容器，AOP 是横切增强；循环依赖依赖三级缓存语境。
...
![](../assets/7cbd3a79fcf9eec5.png)

![](../assets/e27e8079daed79fb.png)
...
![](../assets/5f123e0f20f3f569.png)

![](../assets/b909a01c3004b39b.png)
...
![](../assets/71e5d3adac5c91b0.png)

![](../assets/fd4114191901f79d.png)

...
> [!abstract] 速读地图
> 这篇按 SpringBoot 的「约定、自动装配、Starter、运行监控」来背，突出简化开发的机制。
>
> **本篇关键词：** <span style="color:#16a34a;font-weight:700">SpringBoot</span> ・ <span style="color:#16a34a;font-weight:700">自动装配</span> ・ <span style="color:#16a34a;font-weight:700">Starter</span> ・ <span style="color:#16a34a;font-weight:700">配置绑定</span> ・ <span style="color:#16a34a;font-weight:700">内嵌容器</span> ・ <span style="color:#16a34a;font-weight:700">Actuator</span>
>
> **优先扫这些问题：**
> - 什么是SpringBoot？
...
> [!warning] 易混提醒
> 易混：SpringBoot 不是替代 Spring，而是在 Spring 之上做自动配置和工程化封装。

...
![](../assets/86cb1b56db8b4276.png)

  接下来我们需要思考：handleRequest这个方法需要返回什么信息？

![](../assets/fa6c884d005917de.png)
...
![](../assets/71a9520a2cb2cd91.png)

  怎么映射请求到具体的方法中呢？我们可以通过@RequestMapping注解来指定

![](../assets/dd05cbcd4d07c377.png)

然后对应的定义如下：

![](../assets/8cc40cbb75342c2c.png)

## 3.如何实现多种方式的支持

  上面我们介绍了Controller处理请求的两种方式

![](../assets/11b18eeaaf6a28e8.png)

那如何让SpringMVC框架能够支持这两种方式呢？甚至更多的方式

![](../assets/4569853e744236e7.png)
...
![](../assets/3a0fc0e7a2513c13.png)

![](../assets/767f5b1a952c152a.png)

加入视图名称后，我们在Controller中的方法返回就可以如下的写法了

![](../assets/3cf3c61dcb78d971.png)

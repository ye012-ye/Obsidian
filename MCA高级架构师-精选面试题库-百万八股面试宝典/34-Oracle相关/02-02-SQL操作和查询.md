...
alter table t\_student add constraints pk\_student\_id primary key(id);
...
-- 维护外键关联关系  
alter table t\_student add constraints fk\_student\_classid foreign key(classid) references t\_class(id);

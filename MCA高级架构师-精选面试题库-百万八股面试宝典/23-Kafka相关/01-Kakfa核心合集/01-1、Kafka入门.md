...
*(⚠️ 图片缺失:源知识库原图已失效)*![](../../assets/d0a586e5ba9a742d.png)

（2）并行方式：将注册信息写入数据库成功后，发送注册邮件的同时，发送注册短信。以上三个任务完成后，返回给客户端。与串行的差别是，并行的方式可以提高处理的时间。

假设三个业务节点每个使用50毫秒钟，不考虑网络等其他开销，则串行方式的时间是150毫秒，并行的时间可能是100毫秒。

*(⚠️ 图片缺失:源知识库原图已失效)*![](../../assets/fdbece94e0b02c50.png)

小结：如以上案例描述，传统的方式系统的性能（并发量，吞吐量，响应时间）会有瓶颈。如何解决这个问题呢？

引入消息队列，将不是必须的业务逻辑，异步处理。

*(⚠️ 图片缺失:源知识库原图已失效)*![](../../assets/b3f1234a394f7781.png)
...
*(⚠️ 图片缺失:源知识库原图已失效)*![](../../assets/38cbc1614f9a7866.png)
...
*(⚠️ 图片缺失:源知识库原图已失效)*![](../../assets/5536a4119843cd09.png)
...
*(⚠️ 图片缺失:源知识库原图已失效)*![](../../assets/3f63f753c95b7e38.png)
...
本次课程，将会以kafka\_2.13-3.3.1版本做主讲（这是讲课时的最新版本）。

### 市场主流消息中间件对比

![](../../assets/0a034115c80899cd.png)
...
*(⚠️ 图片缺失:源知识库原图已失效)*![](../../assets/bc09968338bd1c7b.png)
...
*(⚠️ 图片缺失:源知识库原图已失效)*![](../../assets/71289ee137ee83d6.png)
...
![](../../assets/27150b1da9002be6.png)

2、**格式化存储目录**

![](../../assets/150bd39768bf8f5b.png)

3、**启动服务**

![](../../assets/c19ba0d66e211979.png)

启动正确后的界面如下：

![](../../assets/a72bd69f76bd9a74.png)
...
*(⚠️ 图片缺失:源知识库原图已失效)*![](../../assets/aaf3ccba14a399d9.png)
...
*(⚠️ 图片缺失:源知识库原图已失效)*![](../../assets/e79836332b2b83a4.png)

...
![](../assets/a232175826c50c8a.png)

![](../assets/3b98610e1070a45e.png)
...
![](../assets/4bbdbae99e5ca6a4.png)

查看日志我们能够发现查询出来的只有5条记录

![](../assets/844eb0b191eb6e34.png)
...
![](../assets/f1371f8b54a7d2e6.png)

进入 PageSqlSource 的getBoundSql方法中

![](../assets/20d00f73f57b9523.png)
...
| --- | --- | --- |
| **作用** | **描述** | 实现方式 |
| 水平分表 | 一张费用表按月度拆分为12张表。fee\_202001-202012。当查询条件出现月度（tran\_month）时，把select语句中的逻辑表名修改为对应的月份表。 | 对query update方法进行拦截在接口上添加注解，通过反射获取接口注解，根据注解上配置的参数进行分表，修改原SQL，例如id取模，按月分表 |

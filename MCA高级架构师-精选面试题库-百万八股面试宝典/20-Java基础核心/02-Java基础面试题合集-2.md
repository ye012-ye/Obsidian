...
>
> 比如我们的一个项目，短信平台里，需要和运营商去交互，运营商对外提供了一套CMPP（中国移动）的协议，咱们需要根据他的协议去完成一套实现。但是市面上有很多开源框架都对接了CMPP2.0，还是CMPP3.0，我不需要自己再去造一套轮子，我可以拿过来稍微改一改直接应用到项目中。
>
...
>
> **如果线程池掌握的好，可以引导面试官到阻塞队列：ArrayBlockingQueue， LinkedBlockingQueue，明显链表好，可以望这拐。**
...
>
> - 扩展：Set本质是基于HashMap的key去实现的。基于哈希表做到的去重效果。
>
> Map：
>
...
>
> ![](../assets/6f97f2e7c01a9f39.png)**当插入重复元素时，内部流程怎么走的？**
>
> 将之前Node的value做了个替换。。

...
>
> ![](../assets/ad8d6c48b75d36d2.png)
>
> 2、RC隔离级别下，第二次查询会重新创建Read View，可以读取到刚刚提交事务的数据
>
> ![](../assets/db637e0d5e32d7e7.png)
>
> 3、RR隔离级别下，第二次查询不会重新构建Read View，新数据不可见。
>
> ![](../assets/341d401a4f109be7.png)
>
> 4、当前行事务ID不在活跃事务列表中。
>
> ![](../assets/6f63986dd50a7f4c.png)

...
![](../assets/2a1d385d3a342212.png)

授权流程：

![](../assets/6cf640da6e19c6ba.png)
...
- 基于Nginx做ip\_hash策略，但是也只是针对单台服务搭建集群有效果

- 基于Shiro提供的SessionDAO解决，让SessionDAO去与公共的Redis进行交互，存储用户信息

![](../assets/419459b169eff7d9.png)
...
中心化方式：![](../assets/210f8011154559ef.png)

去中心化方式：![](../assets/2b69887bd3ad7047.png)
...
- 采用IDEA打开CAS Server，并加载![](../assets/c478e5086aee0920.png)

- CAS Server默认只支持HTTPS，需要让CAS Server支持HTTP

- Apereo-10000002.json![](../assets/5ff3f1260d582ffc.png)

- HTTPSandIMAPS-10000001.json![](../assets/a48872135848e761.png)

- ticketGrantingTicketCookieGenerator.xml![](../assets/1b4cd9bfb9cd3f67.png)

- warnCookieGenerator.xml![](../assets/7591a97a7252b45d.png)

- deployerConfigContext.xml![](../assets/db5ae89566a457b3.png)
...
- 默认用户名&密码![](../assets/509bfe97a30ca5f7.png)

- 访问首页测试![](../assets/89575b992c595957.png)![](../assets/81d14efc689a444f.png)
...
- CASServer需要支持退出登录后的重定向![](../assets/05e73d5ec3975f1d.png)
